...
<header class="masthead">
    <div class="container">
        <div class="masthead-subheading">Witaj na naszej stronie</div>
        <div class="masthead-heading text-uppercase">zbieramy informacje o rybach</div>
        <a class="btn btn-primary btn-xl text-uppercase" href="#map">Zobacz mapę</a>
    </div>
</header>
...
<section class="page-section bg-light" id="collection">
    <div class="container">
        <div class="text-center">
            <h2 class="section-heading text-uppercase">Kolekcja</h2>
